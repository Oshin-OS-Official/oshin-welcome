...
class ui_welcomescreen(object):
    ...
    def startCheckAction(self):
        if self.launchAtStartCheck.isChecked():
            ...
            autostartfile = os.path.join(homedir, ".config/autostart/oshin-welcome.desktop")
            subprocess.Popen(["cp", "/usr/share/applications/oshin-welcome.desktop", autostartfile])
...
#######################################################################################################################################
    ...
    def setupUi(self, WelcomeScreen):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/usr/share/oshin-welcome/img/oshin-welcome.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Logo.setText("")
        self.Logo.setPixmap(QtGui.QPixmap("/usr/share/oshin-welcome/img/logo.png"))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("/usr/share/oshin-welcome/img/news.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("/usr/share/oshin-welcome/img/forums.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("/usr/share/oshin-welcome/img/helpus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/usr/share/oshin-welcome/img/wiki.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/usr/share/oshin-welcome/img/donate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/usr/share/oshin-welcome/img/install.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, WelcomeScreen):
        ...
        self.welcomeLabel.setText(_translate("WelcomeScreen", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600;\">OSHIN OS</span></p></body></html>"))
        ...
        self.infoLabel.setText(_translate("WelcomeScreen", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Welcome to Oshin OS. The links below will help you get started. Enjoy and feel free to send us your feedback.</span></p></body></html>"))
